    ...
    <div className="min-h-screen bg-[#FAFAFE] pb-28 md:bg-gray-100">
      ...
      <main className="max-w-md mx-auto px-3.5 sm:px-4 pt-8 w-full">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <h2 className="text-lg font-bold text-[#002D55] mb-2">Search Coming Soon</h2>
          <p className="text-sm text-[#929CAD] text-center max-w-xs">
            This feature is under development. You'll be able to search for doctors and specialties here.
          </p>
        </div>
      </main>
