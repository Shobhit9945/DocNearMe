  ...
  return (
    <PageScaffold contentClassName="pb-28 lg:pb-12">
      <header className="bg-white px-4 pt-10 pb-4 border-b border-gray-100 shadow-sm lg:px-10 lg:rounded-t-3xl lg:border-none lg:shadow-none">
        <h1 className="text-2xl font-bold text-[#002D55]">Search</h1>
        <p className="text-sm text-slate-500 mt-2">Find specialists, clinics and hospitals nearby.</p>
      </header>
      ...
      <main className="flex-1 px-4 pt-6 lg:px-10 lg:pt-10">
        <div className="flex flex-col gap-8 lg:flex-row">
          <section className="flex-1 rounded-[24px] border border-dashed border-[#0089FF]/40 bg-white p-8 text-center shadow-sm">
            ...
            <h2 className="text-xl font-bold text-[#002D55] mb-2">Search Coming Soon</h2>
          ...
          <aside className="hidden lg:flex lg:w-1/3 flex-col gap-4">
            <div className="rounded-2xl bg-white p-6 shadow-sm border border-slate-100">
              <p className="text-xs uppercase tracking-wide text-slate-500">Roadmap sneak peek</p>
              <ul className="mt-4 space-y-3 text-sm text-slate-600">
                <li className="flex items-center gap-2"><ArrowRight className="w-4 h-4 text-[#0089FF]" /> Specialty search with DocDaisy hand-off</li>
                <li className="flex items-center gap-2"><ArrowRight className="w-4 h-4 text-[#0089FF]" /> Realtime slot availability</li>
                <li className="flex items-center gap-2"><ArrowRight className="w-4 h-4 text-[#0089FF]" /> Saved providers & favourites</li>
              </ul>
            </div>
