...
import { Users, Calendar, Star, Clock, Bell, CheckCircle2 } from "lucide-react";
    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between mb-8">
        ...
        <div className="hidden md:flex items-center gap-3 text-sm text-gray-500">
          ...
          <span>Clinic hours: 09:00-18:00</span>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm space-y-4">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            ...
            <li className="flex items-start gap-2">
              <span className="mt-1 h-2 w-2 rounded-full bg-blue-500" />
              Update next week's hours.
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 h-2 w-2 rounded-full bg-blue-500" />
              Add photos to improve bookings.
            </li>
          </ul>
          <div className="border-t border-gray-100 pt-4">
            <p className="text-sm text-gray-500">Only the essentials are shown.</p>
          </div>
        </div>
      </div>
    </div>
