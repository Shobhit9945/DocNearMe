...
const phoneCountries: PhoneCountry[] = [
  ...
  { name: "American Samoa", iso: "AS", dialCode: "+1" },
  { name: "Andorra", iso: "AD", dialCode: "+376" },
  { name: "Angola", iso: "AO", dialCode: "+244" },
  { name: "Anguilla", iso: "AI", dialCode: "+1" },
  { name: "Antarctica", iso: "AQ", dialCode: "+672" },
  { name: "Antigua and Barbuda", iso: "AG", dialCode: "+1" },
  { name: "Argentina", iso: "AR", dialCode: "+54" },
  { name: "Armenia", iso: "AM", dialCode: "+374" },
  { name: "Aruba", iso: "AW", dialCode: "+297" },
  ...
  { name: "Barbados", iso: "BB", dialCode: "+1" },
  ...
  { name: "Bermuda", iso: "BM", dialCode: "+1" },
  { name: "Bhutan", iso: "BT", dialCode: "+975" },
  { name: "Bolivia", iso: "BO", dialCode: "+591" },
  { name: "Bonaire, Sint Eustatius and Saba", iso: "BQ", dialCode: "+599" },
  { name: "Bosnia and Herzegovina", iso: "BA", dialCode: "+387" },
  { name: "Botswana", iso: "BW", dialCode: "+267" },
  { name: "Bouvet Island", iso: "BV", dialCode: "+47" },
  { name: "Brazil", iso: "BR", dialCode: "+55" },
  { name: "British Indian Ocean Territory", iso: "IO", dialCode: "+246" },
  ...
  { name: "Cayman Islands", iso: "KY", dialCode: "+1" },
  ...
  { name: "Christmas Island", iso: "CX", dialCode: "+61" },
  { name: "Cocos (Keeling) Islands", iso: "CC", dialCode: "+61" },
  { name: "Colombia", iso: "CO", dialCode: "+57" },
  { name: "Comoros", iso: "KM", dialCode: "+269" },
  { name: "Congo", iso: "CG", dialCode: "+242" },
  { name: "Congo (Democratic Republic of the)", iso: "CD", dialCode: "+243" },
  { name: "Cook Islands", iso: "CK", dialCode: "+682" },
  ...
  { name: "Curaçao", iso: "CW", dialCode: "+599" },
  ...
  { name: "Dominica", iso: "DM", dialCode: "+1" },
  { name: "Dominican Republic", iso: "DO", dialCode: "+1" },
  ...
  { name: "Falkland Islands (Malvinas)", iso: "FK", dialCode: "+500" },
  { name: "Faroe Islands", iso: "FO", dialCode: "+298" },
  { name: "Fiji", iso: "FJ", dialCode: "+679" },
  { name: "Finland", iso: "FI", dialCode: "+358" },
  { name: "France", iso: "FR", dialCode: "+33" },
  { name: "French Guiana", iso: "GF", dialCode: "+594" },
  { name: "French Polynesia", iso: "PF", dialCode: "+689" },
  { name: "French Southern Territories", iso: "TF", dialCode: "+262" },
  ...
  { name: "Gibraltar", iso: "GI", dialCode: "+350" },
  { name: "Greece", iso: "GR", dialCode: "+30" },
  { name: "Greenland", iso: "GL", dialCode: "+299" },
  { name: "Grenada", iso: "GD", dialCode: "+1" },
  { name: "Guadeloupe", iso: "GP", dialCode: "+590" },
  { name: "Guam", iso: "GU", dialCode: "+1" },
  { name: "Guatemala", iso: "GT", dialCode: "+502" },
  { name: "Guernsey", iso: "GG", dialCode: "+44" },
  ...
  { name: "Heard Island and McDonald Islands", iso: "HM", dialCode: "+672" },
  { name: "Holy See", iso: "VA", dialCode: "+379" },
  ...
  { name: "Korea (Democratic People's Republic of)", iso: "KP", dialCode: "+850" },
  { name: "Korea, Republic of", iso: "KR", dialCode: "+82" },
  { name: "Kuwait", iso: "KW", dialCode: "+965" },
  { name: "Kyrgyzstan", iso: "KG", dialCode: "+996" },
  { name: "Lao People's Democratic Republic", iso: "LA", dialCode: "+856" },
  ...
  { name: "Macao", iso: "MO", dialCode: "+853" },
  ...
  { name: "Martinique", iso: "MQ", dialCode: "+596" },
  { name: "Mauritania", iso: "MR", dialCode: "+222" },
  { name: "Mauritius", iso: "MU", dialCode: "+230" },
  { name: "Mayotte", iso: "YT", dialCode: "+262" },
  { name: "Mexico", iso: "MX", dialCode: "+52" },
  { name: "Micronesia (Federated States of)", iso: "FM", dialCode: "+691" },
  ...
  { name: "Montserrat", iso: "MS", dialCode: "+1" },
  ...
  { name: "New Caledonia", iso: "NC", dialCode: "+687" },
  ...
  { name: "Niue", iso: "NU", dialCode: "+683" },
  { name: "Norfolk Island", iso: "NF", dialCode: "+672" },
  { name: "North Macedonia", iso: "MK", dialCode: "+389" },
  { name: "Northern Mariana Islands", iso: "MP", dialCode: "+1" },
  ...
  { name: "Palestine, State of", iso: "PS", dialCode: "+970" },
  ...
  { name: "Pitcairn", iso: "PN", dialCode: "+64" },
  ...
  { name: "Réunion", iso: "RE", dialCode: "+262" },
  { name: "Romania", iso: "RO", dialCode: "+40" },
  { name: "Russian Federation", iso: "RU", dialCode: "+7" },
  { name: "Rwanda", iso: "RW", dialCode: "+250" },
  { name: "Saint Barthélemy", iso: "BL", dialCode: "+590" },
  { name: "Saint Helena, Ascension and Tristan da Cunha", iso: "SH", dialCode: "+290" },
  { name: "Saint Kitts and Nevis", iso: "KN", dialCode: "+1" },
  { name: "Saint Lucia", iso: "LC", dialCode: "+1" },
  { name: "Saint Martin (French part)", iso: "MF", dialCode: "+590" },
  { name: "Saint Pierre and Miquelon", iso: "PM", dialCode: "+508" },
  { name: "Saint Vincent and the Grenadines", iso: "VC", dialCode: "+1" },
  { name: "Samoa", iso: "WS", dialCode: "+685" },
  { name: "San Marino", iso: "SM", dialCode: "+378" },
  { name: "Sao Tome and Principe", iso: "ST", dialCode: "+239" },
  ...
  { name: "Sint Maarten (Dutch part)", iso: "SX", dialCode: "+1" },
  ...
  { name: "South Georgia and the South Sandwich Islands", iso: "GS", dialCode: "+500" },
  ...
  { name: "Svalbard and Jan Mayen", iso: "SJ", dialCode: "+47" },
  { name: "Sweden", iso: "SE", dialCode: "+46" },
  { name: "Switzerland", iso: "CH", dialCode: "+41" },
  { name: "Syrian Arab Republic", iso: "SY", dialCode: "+963" },
  ...
  { name: "United States Minor Outlying Islands", iso: "UM", dialCode: "+1" },
  ...
  { name: "Viet Nam", iso: "VN", dialCode: "+84" },
  { name: "Virgin Islands (British)", iso: "VG", dialCode: "+1" },
  { name: "Virgin Islands (U.S.)", iso: "VI", dialCode: "+1" },
  { name: "Wallis and Futuna", iso: "WF", dialCode: "+681" },
  { name: "Western Sahara", iso: "EH", dialCode: "+212" },
...
export const phoneCountryOptions = phoneCountries
  .map((country) => ({
    ...country,
    flag: toFlagEmoji(country.iso),
  }))
